local function tameMonster(cid, item, itemEx, tame, run, broken)
	n = math.random(100)
	if n <= broken then
		doCreatureSay(cid, "The item has broken.", TALKTYPE_ORANGE_1)
		doRemoveItem(item.uid)
	elseif n > broken and n <= (tame+broken) then
		doRemoveItem(item.uid)
		doCreatureSay(cid, "You tamed the monster!", TALKTYPE_ORANGE_1)
		doPlayerSendTextMessage(cid, MESSAGE_STATUS_CONSOLE_BLUE, "You tammed successfully! "..getCreatureName(itemEx.uid)..".")
		return true
	elseif n > (tame+broken) and n <= (tame+broken+run) then
		doCreatureSay(cid, "The monster ran away!", TALKTYPE_ORANGE_1)
...
local function inArray(table, value)
 ...
 local mounts = {
 {item = 13307, name = "wailing widow", id = 1, tame=30, run=50, broken=20},
 {item = 13298, name = "terror bird", id = 2, tame=30, run=30, broken=40},
 {item = 5907, name = "bear", id = 3, tame=40, run=30, broken=30},
 {item = 13295, name = "black sheep", id = 4, tame=40, run=30, broken=30},
 {item = 13293, name = "midnight panther", id = 5, tame=20, run=60, broken=20},
 {item = 13538, name = "panda", id = 19, tame=50, run=25, broken=25},
 {item = 13539, name = "enraged white deer", id = 18, tame=40, run=30, broken=30},
 ...
 {item = 13508, name = "slug", id = 14, tame=50, run=30, broken=20},
 ...
 {item = 13938, name = "uniwheel", id = 15, tame=40, run=30, broken=30},
 {item = 13292, name = "tin lizzard", id = 8, tame=40, run=30, broken=30},
 {item = 15546, name = "lady bug", id = 27, tame=40, run=30, broken=30},
 {item = 15545, name = "manta ray", id = 28, tame=40, run=30, broken=30},
 {item = 18447, name = "ironblight", id = 30, tame=40, run=30, broken=30},
 {item = 18448, name = "magma crawler", id = 31, tame=40, run=30, broken=30},
 {item = 18449, name = "dragonling", id = 32, tame=50, run=15, broken=35},
 {item = 18516, name = "gnarlhound", id = 33, tame=40, run=30, broken=30},
